export default function Dashboard() {
  return (
    <main style={{ display: 'flex', height: '100vh', width: '100vw' }}>
      <div style={{ flex: 1, background: 'var(--personal-bg)', borderRight: '1px solid var(--personal-border)', padding: '1.5rem' }}>
      ...
      <div style={{ flex: 1, background: 'var(--rp-navy)', color: 'var(--rp-white)', padding: '1.5rem' }}>
